...
function enablemodal()
{
	...
	if(document.getElementsByClassName('tcontent')[0].children[10].innerHTML=="Yes")
	{
...
function update1()
{
	...
	if(form[1].children[19].checked==true)
	{
	 ...
	 document.getElementsByClassName('tcontent')[0].children[10].innerHTML="Yes";
	}
	else
	{
		document.getElementsByClassName('tcontent')[0].children[10].innerHTML="No";
	}
